                            ...
                            <div class="form-outline">
                                <div class="form-group text-right">
                                    <div class="btns-group">
                                        ...
                                        <button type="button" onclick="location.href='/StarListMaker/assets/pages/person/edit.php';" class="btn btn-warning text-white btn-block" id="btn_edit"><i class='fa fa-edit'></i> Editar</button>

                                        <button type="button" onclick="location.href='/StarListMaker/assets/pages/person/delete.php';" class="btn btn-danger btn-block" id="btn_delete"><i class='fa fa-trash'></i> Eliminar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
