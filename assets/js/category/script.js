$(document).ready(function () {
    ...
    var dataTable = $('#table_category').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "/StarListMaker/assets/services/category/obtener_registros.php",
            "type": "POST"
        },
        "columnDefs": [
            {
    ...
    $(document).on('submit', '#form_category', function (event) {
        ...
        if (name != '' && state_id != '') {
            $.ajax({
                url: "/StarListMaker/assets/services/category/crear.php",
                method: "POST",
    ...
    $(document).on('click', '.edit', function () {
        ...
        $.ajax({
            url: "/StarListMaker/assets/services/category/obtener_regitro.php",
            method: "POST",
            data: { id: id },
            dataType: "JSON",
            success: function (data) {
    ...
    $(document).on('click', '.delete', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "/StarListMaker/assets/services/category/eliminar.php",
                    method: "POST",
                    data: { id: id },
                    success: function (data) {
                        Swal.fire({
