...
<body>
    ...
    <main>
        <div class="container--all d-flex justify-content-center align-items-center">
            <div class="card w-100">
                <div class="card-header d-flex flex-row justify-content-center align-items-center p-3 w-100">
                    <h3 class="m-0 me-auto h-100" id="title"><?php echo strtoupper("Tipos de Establecimientos"); ?></h3>

                    <!-- Button trigger modal -->
                    <button type="button" class="ms-2 btn btn-primary" data-bs-toggle="modal" title="Nuevo" data-bs-target="#modal_establishment_type" id="btnCreate">
                        <i class="fa fa-add"></i>
                    </button>
                </div>
                ...
                <div class="card-body p-3 w-100">
                    <div class="table-responsive p-1 w-100">
                        <table class="table table-striped table-hover table-bordered table-condensed display nowrap" id="table_establishment_type" style="width: 100%">
                            <thead>
                                <tr>
                                    <th></th>
        ...
        <!-- Modal -->
        <div class="modal fade" id="modal_establishment_type" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="POST" id="form_establishment_type" enctype="multipart/form-data" class="mw-100">
                        <div class="modal-content">
    ...
    <?php
        ...
        $script->GetEstablishmentType($url);
    ?>
</body>
