$(document).ready(function () {
    ...
    var dataTable = $('#table_brand').DataTable({
        "language": {
            "lengthMenu":
                "Mostrar " +
        ...
        "order": [],
        "ajax": {
            "url": "/StarListMaker/assets/services/brand/obtener_registros.php",
            "type": "POST"
        },
        "columnDefs": [
            {
    ...
    $(document).on('submit', '#form_brand', function (event) {
        ...
        if (name != '' && state_id != '') {
            $.ajax({
                url: "/StarListMaker/assets/services/brand/crear.php",
                method: "POST",
    ...
    $(document).on('click', '.edit', function () {
        ...
        $.ajax({
            url: "/StarListMaker/assets/services/brand/obtener_regitro.php",
            method: "POST",
            data: { id: id },
            dataType: "JSON",
            success: function (data) {
    ...
    $(document).on('click', '.delete', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "/StarListMaker/assets/services/brand/eliminar.php",
                    method: "POST",
                    data: { id: id },
                    success: function (data) {
                        Swal.fire({
