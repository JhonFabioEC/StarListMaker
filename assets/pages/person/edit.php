...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <form method="POST" id="form_person_edit" class="form shadow-lg rounded" enctype="multipart/form-data">
                    <div class="row">
                            ...
                            <div class="form-outline">
                                <div class="form-group d-flex w-100 justify-content-center">
                                    <div id="image_upload" class="overflow-hidden" style="width: 200px; height: 200px;">
                                        <img src="/StarListMaker/assets/img/user/person/<?php echo $person['image'] ?>" id="img" class="img-thumbnail border border-5 bg-transparent rounded-circle w-100 h-100" />
                                        <input type="hidden" name="image_hidden" id="image_hidden" value="<?php echo $person['image'] ?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 mb-4">
                            <div class="form-outline">
                                <div class="form-group text-center">
                                    ...
                                    <input type="hidden" name="verify" id="verify" class="col-1 d-none" value="<?php echo $person['password'] ?>" readonly required='true' />
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="form-outline">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="first_name" id="first_name" class="form-control" value="<?php echo $person['first_name'] ?>" required='true' />
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="form-outline">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="last_name" id="last_name" class="form-control" value="<?php echo $person['last_name'] ?>" required='true' />
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="form-outline">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address" id="address" class="form-control w-100" value="<?php echo $person['address'] ?>" required='true' />
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="form-outline">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone_number" id="phone_number" class="form-control w-100" value="<?php echo $person['phone_number'] ?>" required='true' />
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="form-outline">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email_address" id="email_address" class="form-control w-100" value="<?php echo $person['email_address'] ?>" required='true' />
