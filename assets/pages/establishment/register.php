...
<body>
    ...
    <form action="#" method="POST" id="form_establishment" class="form shadow-lg rounded">
        ...
        <div class="form-step form-step-active">
            <div class="form-outline mb-3">
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control w-100" required='true' />
            ...
            <div class="form-outline mb-3">
                ...
                <select id="establishment_type_id" name="establishment_type_id" class="form-control w-100" required='true'>
                    <option value="">Seleccionar establecimiento</option>
                    <?php
                    foreach ($establishment_type as $gd) {
        ...
        <div class="form-step">
            ...
            <div class="btns-group mt-4">
                ...
                <button type="submit" class="btn btn-primary btn-p5 disabled btn-block" id="btn_create">Crear</button>
            </div>
        </div>
    ...
    $script->GetEstablishmentValidate($url);
