...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <form method="POST" id="form_establishment_delete" class="form shadow-lg rounded"
                        ...
                        <div class="col-lg-12 mb-4">
                            <div class="form-group text-center">
                                <span id="image_upload">
                                    <img src="/StarListMaker/assets/img/user/establishment/<?php echo $establishment['image'] ?>"
                                        class="img-fluid img-thumbnail border border-5 bg-transparent rounded-circle"
                                        width="200" height="200" />
                                    <input type="hidden" name="image_hidden"
                                        value="<?php echo $establishment['image'] ?>" />
                                </span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-outline">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control"
                                        value="<?php echo $establishment['name'] ?>" disabled readonly
                                        required='true' />
                            ...
                            <div class="form-outline">
                                <div class="form-group">
                                    ...
                                    <select id="establishment_type_id" name="establishment_type_id"
                                        class="form-control w-100" disabled readonly required='true' />
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="form-outline">
                                <div class="form-group">
                                    ...
                                    <select id="department_id" name="department_id" class="form-control w-100" disabled
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="form-outline">
                                <div class="form-group">
                                    ...
                                    <select id="municipality_id" name="municipality_id" class="form-control w-100"
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="form-outline">
                                <div class="form-group">
                                    ...
                                    <select id="zone_type_id" name="zone_type_id" class="form-control w-100" disabled
                                        readonly required='true'>
                            ...
                            <div class="form-outline">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address" id="address" class="form-control w-100"
                                        value="<?php echo $establishment['address'] ?>" disabled readonly
                                        required='true' />
                            ...
                            <div class="form-outline">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone_number" id="phone_number" class="form-control w-100"
                                        value="<?php echo $establishment['phone_number'] ?>" disabled readonly
                                        required='true' />
                            ...
                            <div class="form-outline">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email_address" id="email_address"
                                        class="form-control w-100" value="<?php echo $establishment['email_address'] ?>"
                                        disabled readonly required='true' />
                            ...
                            <div class="form-outline">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="username" id="username" class="form-control w-100"
                                        value="<?php echo $establishment['username'] ?>" disabled readonly
                                        required='true' />
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="form-outline">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="password" id="password" class="form-control w-100"
                                        value="●●●●●●●●" disabled readonly required='true' />
                            ...
                            <div class="form-outline">
                                <div class="form-group text-right">
                                    <div class="btns-group">
                                        <input type="hidden" name="id" id="id" value="<?php echo $establishment['user_id'] ?>" >

                                        <button type="button"
                                            onclick="location.href='/StarListMaker/assets/pages/establishment/view.php';"
                                            class="btn btn-secondary btn-block" id="btn_back"><i class="fa-solid fa-caret-left"></i> Atras</button>
